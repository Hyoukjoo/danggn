...
interface I_props {
  filter: I_Filter | undefined;
  showFilterModal: () => void;
  setFilter: React.Dispatch<React.SetStateAction<I_Filter | undefined>>;
}

const TopFilterModal: React.FC<I_props> = ({ filter, setFilter, showFilterModal }) => {
  ...
  const onSumbitFilter = () => {
    ...
    let filter = { startOld, endOld, startMileage, endMileage, isSmoker };

    if (startOld > endOld) filter = { ...filter, startOld: endOld, endOld: startOld };
    if (startMileage > endMileage) filter = { ...filter, startMileage: endMileage, endMileage: startMileage };
      ...
      <div className="filter-modal-container">
        <div className="filter-modal-header">
          ...
          <div className="clear-button">
            <i className="material-icons" onClick={showFilterModal}>
              clear
            </i>
          </div>
        </div>
        <div className="filter-modal-body">
          ...
          <div className="range-slider-container">
            ...
            <div className="range-slider-input">
              ...
              <input type="range" value={startMileage} min={0} max={10000} step={100} onChange={onChangeStartMileage} />
            </div>
            <div className="range-slider-info">
              <span>
                <strong>
        ...
        <div className="filter-modal-footer">
          ...
          <div className="clear-button" onClick={showFilterModal}>
            <span>취소</span>
          </div>
